...
const int32_t PSQT[6][64] = {
...

    {
        ...
        S(66, 123), S(116, 127), S(79, 110), S(92, 113), S(97, 112), S(95, 104), S(115, 136), S(97, 109)
    },

    {
        S(115, 168), S(89, 175), S(94, 170), S(59, 180), S(84, 174), S(100, 164), S(116, 162), S(97, 164),
        S(121, 157), S(131, 159), S(124, 160), S(111, 161), S(139, 151), S(139, 153), S(140, 161), S(134, 154),
        S(130, 175), S(146, 162), S(141, 160), S(155, 150), S(148, 155), S(183, 157), S(167, 159), S(162, 170),
        S(128, 170), S(131, 168), S(142, 159), S(155, 169), S(148, 162), S(144, 164), S(133, 163), S(128, 168),
...

    {
        ...
        S(153, 306), S(162, 302), S(160, 310), S(168, 305), S(169, 293), S(180, 286), S(189, 283), S(191, 279),
    ...
    {
        S(370, 566), S(353, 587), S(371, 605), S(402, 590), S(401, 594), S(406, 591), S(447, 536), S(404, 567),
        S(376, 557), S(349, 586), S(353, 615), S(344, 631), S(349, 650), S(389, 612), S(385, 590), S(427, 583),
        S(376, 560), S(369, 565), S(364, 597), S(372, 605), S(386, 614), S(421, 599), S(435, 565), S(436, 570),
        S(362, 566), S(362, 573), S(360, 584), S(361, 599), S(360, 613), S(375, 606), S(383, 600), S(390, 595),
        S(366, 562), S(357, 581), S(359, 578), S(364, 592), S(364, 588), S(365, 585), S(374, 583), S(384, 582),
        S(366, 552), S(369, 559), S(366, 569), S(366, 561), S(366, 566), S(373, 564), S(384, 553), S(382, 558),
        S(374, 547), S(371, 544), S(379, 536), S(380, 541), S(377, 545), S(380, 520), S(386, 501), S(410, 490),
        S(369, 547), S(369, 540), S(374, 536), S(381, 546), S(379, 523), S(354, 536), S(377, 519), S(382, 519)
    },

    {
        S(35, -93), S(20, -40), S(62, -31), S(-77, 17), S(-28, 0), S(-8, 2), S(26, -9), S(109, -110),
        S(-104, 5), S(-15, 34), S(-44, 48), S(61, 31), S(7, 50), S(1, 61), S(15, 49), S(-48, 18),
        S(-107, 18), S(29, 40), S(-10, 67), S(-25, 79), S(9, 78), S(63, 69), S(16, 58), S(-43, 23),
        S(-69, 5), S(-51, 45), S(-54, 74), S(-83, 96), S(-79, 95), S(-56, 78), S(-75, 58), S(-129, 30),
...
const int32_t mobilities[5][28] = {
    ...
    {
        S(0, 0), S(0, 0), S(0, 0), S(408, 271), S(371, 405), S(396, 456), S(400, 474), S(398, 536), S(404, 548), S(403, 568), S(407, 575), S(409, 586), S(411, 597), S(413, 600), S(417, 605), S(418, 613), S(418, 620), S(420, 627), S(421, 632), S(422, 636), S(424, 645), S(428, 644), S(430, 646), S(438, 643), S(439, 642), S(452, 640), S(491, 619), S(544, 598),
    },
...
const int32_t passed_pawns[9]{
    S(11, -22), S(4, 3), S(-10, 31), S(-22, 44), S(-30, 26), S(-32, 30), S(-69, 22), S(5, -38), S(-91, -37),
};
